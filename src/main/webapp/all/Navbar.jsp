	...
	<div class="row p-3">
		...
		<div class="col-md-3 ">
			...
			<c:if test="${not empty userObj }">
				...
				<a class="btn btn-success" data-toggle="modal" data-target="#staticBackdrop1"> <i
...
<div class="container-fluid narbar_back_color">
	<div class="row">
		...
		<div class="col-3">
			...
			if (u1 == null) {
			%>
			<a class="btn btn-info mt-3 ml-4" data-toggle="modal"
					data-target="#exampleModal1">
			...
			%>
			<a class="btn btn-info mt-3 ml-4" data-toggle="modal"
					data-target="#exampleModal1"> <i class="fa-solid fa-phone"></i>
				Contact us
			</a>
			<%
			} else {
